...
func (p Professor) Informar() string {
	return fmt.Sprintf("Professor: %s, Matérias: %v", p.nome, p.materias)
}
...
func main() {
	...
	professor1 := &Professor{nome: "Julia", materias: []string{"Matemática", "Portugues"}}
	professor2 := &Professor{nome: "Carlos", materias: []string{"Química", "Biologia"}}
